!(function (n, i) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define(i)
      : ((n = 'undefined' != typeof globalThis ? globalThis : n || self).PinyinMatch = i());
})(this, function () {
  'use strict';
  function n(n, i, a) {
    return (
            ...
            if (
              ...
              if (1 === t.length) u.push(t);
                ...
                (i.forEach(function (n) {
                  0 === n.indexOf(t) && f.push(n);
                }),
                  u.push(f));
              }
              g = !0;
            } else -1 !== i.indexOf(t) && r[h + 1] && (u.push(t), (g = !0));
            if (g) {
              var l = e.length;
              (o(h + 1, a, u, e, r), e.length === l && (r[h + 1] = !1), u.pop());
            }
          },
          h = n;
        t > h;
  ...
  function g(i, o) {
    ...
    return h(
      ...
      u[o] ||
        ((l = []),
        e((f = o)).forEach(function (n) {
          var i = n.split(' '),
            a = i.length - 1;
          i[a].indexOf(',')
            ? i[a].split(',').forEach(function (n) {
                (i.splice(a, 1, n), l.push(JSON.parse(JSON.stringify(i))));
              })
            : l.push(i);
        }),
        (0 !== l.length && l[0].length === f.length) || l.push(f.split('')),
        (u = n({}, f, l)),
        l),
      o
    );
  ...
  function h(n, i, a) {
    for (var u = 0; n.length > u; u++)
      for (var e = 0; i.length > e; e++) {
        ...
        if (n.length >= t) {
          for (; o.length > f; f++)
            if (0 === f && ' ' === n[u + f + l]) ((l += 1), (f -= 1));
            else if (' ' === n[u + f + c]) ((c += 1), (f -= 1));
            else if (!r(n[u + f + c], o[f], !n[u + f + 1] || !o[f + 1], g)) {
              h = !1;
              break;
            }
          if (h) return [u + l, c + u + f - 1];
        }
      }
    return !1;
  }
      ...
      return (
        Object.keys(n).forEach(function (a) {
          if (((u[a] = n[a]), i.push(a), e.includes(a))) {
            var r = -1 !== (t = a).indexOf('u') ? t.replace('u', 'v') : t.replace('v', 'u');
            ((u[r] = n[a]), i.push(r));
          }
          var t;
          if (o.includes(a)) {
        ...
        (a = (function (n) {
          var i = {};
          for (var a in n)
            for (var u = n[a], e = 0, o = u.length; o > e; e++)
              i[u[e]] = i[u[e]] ? i[u[e]] + ' ' + a : a;
          return i;
        })(u)),
        g
      );
